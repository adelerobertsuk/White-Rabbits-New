# Glow implementation context

Updated 9 September 2026.

Scope: Home ring and current-month Collection rim only. Reference image is inspiration for ring/glow, not a screen redesign. Preserve bunny assets, layout, typography, navigation, collection and settings structures.

HomeView.swift: light-mode ring now uses a 2 pt silver-blue base at 0.42 opacity, 3 pt champagne-white progress arc at 0.92 opacity, tighter pearl halos and a contrasting under-edge. Competing light-mode full-circle core and inner lip are hidden. Existing dark-mode treatment and bunny animation remain.

StampCardView.swift: current-month light-mode rim has a champagne under-edge, silver-blue base and white-pearl highlight with tighter halos. Other month treatments remain.

Existing uncommitted changes were present before this task. Do not revert them. Before-edit copies of the two views are in /tmp/white-rabbits-glow for this session.
